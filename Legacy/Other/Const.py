...
class Dissertation_Const_1D:
    def __init__(self, D=1.0, rho=1.0, K=1.0, k=1.0,
                 ...
                 scheme="AB2AM2", init_type="step", steepness =0.1, const = 0.1):
    ...
    def solve(self):
        ...
        g_prev = g_numba(N_prev, M_prev, self.k, self.const)
        ...
        for i in range(2, self.Nt):
            ...
            g_curr = g_numba(N_curr, M_curr, self.k, self.const)
